...
public interface CarRepository extends CrudRepository<Car, Long> {
	...
	@Query("SELECT DISTINCT c.model FROM Car c RIGHT JOIN c.manufacturer m WHERE m.id=:id")
	...
	@Query("SELECT c FROM Car c RIGHT JOIN c.manufacturer m WHERE c.body like %:body% and c.model like %:model% and c.color like %:color% and c.status=:status and c.capacity=:capacity and m.name like %:name% and c.price BETWEEN :pricefrom AND :priceto")
	...
	@Query("SELECT c FROM Car c RIGHT JOIN c.manufacturer m WHERE c.body like %:body% and c.model like %:model% and c.color like %:color% and c.capacity=:capacity and m.name like %:name% and c.price BETWEEN :pricefrom AND :priceto")
	...
	@Query("SELECT c FROM Car c RIGHT JOIN c.manufacturer m WHERE c.body like %:body% and c.model like %:model% and c.color like %:color% and c.status=:status and m.name like %:name% and c.price BETWEEN :pricefrom AND :priceto")
	...
	@Query("SELECT c FROM Car c RIGHT JOIN c.manufacturer m WHERE c.body like %:body% and c.model like %:model% and c.color like %:color% and m.name like %:name% and c.price BETWEEN :pricefrom AND :priceto ")
